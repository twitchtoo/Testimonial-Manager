...
// forum/bb link:
  ...
  //bof Testimonials add link
  if (DEFINE_TESTIMONIAL_STATUS <= 1) {
    $information[] = '<a href="' . zen_href_link(FILENAME_TESTIMONIALS_MANAGER_ALL) . '">' . BOX_HEADING_TESTIMONIALS_MANAGER . '</a>';
  }
  //eof Testimonials add link
